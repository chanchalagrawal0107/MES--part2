...
//     res.status(201).json({
//       success: true, token, user: {id: newUser._id, name: newUser.name, email: newUser.email}
//     });
//   }
//   catch(error){
//     console.error(error);
...
// // Reset Password API (simplified without email)
...
const router = express.Router();
const jwt = require('jsonwebtoken');
const { sql, poolPromise } = require('../db/userdb');  // ✅ Use correct DB connection
